...
namespace Northwind.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("Categories","产品分类")]
   partial class Category: DataEntity<Category>, IDataEntity<Category>
   {
       public Category()
       {
       }
       ...
       /// 类型ID 。
       /// </summary>
       [Column("CategoryID","类型ID"),PrimaryKey,NotNull]
       [DisplayName("类型ID")]
       ...
       /// 类型名 。
       /// </summary>
       [Column("CategoryName","类型名"),DataSize(128),NotNull]
       [DisplayName("类型名")]
       ...
       /// 类型说明 。
       /// </summary>
       [Column("Description","类型说明"),DataSize(128)]
       [DisplayName("类型说明")]
