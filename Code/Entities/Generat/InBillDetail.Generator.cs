...
namespace Northwind.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("InBillDetails","入库单据明细")]
   partial class InBillDetail: DataEntity<InBillDetail>, IDataEntity<InBillDetail>
   {
       public InBillDetail()
       {
       }
       
       protected InBillDetail(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 单据号 。
       /// </summary>
       [Column("OrderID","单据号"),DataSize(16),NotNull]
       [DisplayName("单据号")]
       ...
       /// </summary>
       [XmlIgnore]
       [RefEntity("ProductID", "产品字典", typeof(Product), "ProductID", false, true)]
